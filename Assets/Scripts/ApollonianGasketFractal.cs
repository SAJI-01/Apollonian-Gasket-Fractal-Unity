...
public class ApollonianGasketFractal : MonoBehaviour
{
    ...
    public void CreateNewCircles()
    {
        ...
        CreateLineRenderer(c1);
        CreateLineRenderer(c2);
        CreateLineRenderer(c3);
    ...
    private void CreateLineRenderer(Circle circle)
    {
        GameObject lineObj = new GameObject($"CircleLine_{lineRenderers.Count}");
        ...
        circle.Draw(lineRenderer, steps);
